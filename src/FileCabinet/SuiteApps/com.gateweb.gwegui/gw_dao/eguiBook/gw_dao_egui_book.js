define([
  ...
  '../../library/ramda.min',
  './gw_record_fields',
  '../../library/gw_wrapper_lib',
], function (record, gwDateUtil, gwSearch, ramda, fieldConfig, gwWrapper) {
  /**
   * Module Description...
   *
   ...
   */
  var exports = {}
  var recordTypeId = 'customrecord_gw_gui_book'
  var columnObj = fieldConfig.fieldIds
  ...
  function getAllOptionsCore() {
    ...
    var result = gwSearch.runSearch(recordTypeId, searchColumns, searchFilter)
  ...
  function transformBookToRecordObj(bookObj) {
    var guiBookRecordObj = {}
    Object.keys(bookObj).forEach(function (attribute) {
      var fieldId = fieldConfig.fieldInputMapping[attribute]
      if (fieldId) {
        guiBookRecordObj[fieldId] = bookObj[attribute]
      }
    })
    return guiBookRecordObj
  }
  ...
  exports.transformBookToRecordObj = transformBookToRecordObj
  return exports
})
