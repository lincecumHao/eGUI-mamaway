define(['../../library/ramda.min'], function (ramda) {
   ...
   */
  var exports = {}
  var recordId = 'customrecord_gw_evidence_status'
  var fieldConfig = {
    name: {
      id: 'name',
      sourceField: '',
    ...
    custrecord_gw_evidence_status_value: {
      id: 'custrecord_gw_evidence_status_value',
      sourceField: '',
      outputField: 'value'
    },
    custrecord_gw_evidence_status_text: {
      id: 'custrecord_gw_evidence_status_text',
      sourceField: '',
      outputField: 'text'
    }
  }
