define(['../../library/ramda.min'], function(ramda) {
   ...
   */
  var exports = {}
  var recordId = 'customrecord_gw_ap_doc_deduct_option'
  var fieldConfig = {
    name: {
      id: 'name',
      sourceField: '',
    ...
    custrecord_gw_ap_doc_deduct_value: {
      id: 'custrecord_gw_ap_doc_deduct_value',
      sourceField: '',
      outputField: 'value',
    },
    custrecord_gw_ap_doc_deduct_text: {
      id: 'custrecord_gw_ap_doc_deduct_text',
      sourceField: '',
      outputField: 'text',
    },
    custrecord_gw_ap_doc_deduct_csv_value: {
      id: 'custrecord_gw_ap_doc_deduct_csv_value',
      sourceField: '',
