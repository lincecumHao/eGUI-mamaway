define(['../../library/ramda.min'], function (ramda) {
  ...
  var fieldConfig = {
    ...
    custrecord_gw_custom_export_cate_value: {
      id: 'custrecord_gw_custom_export_cate_value',
      sourceField: '',
      outputField: 'value',
    },
    custrecord_gw_custom_export_cate_text: {
      id: 'custrecord_gw_custom_export_cate_text',
      sourceField: '',
      outputField: 'text',
    },
  }
