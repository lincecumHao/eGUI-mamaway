...
define([
    ...
    const getInputData = (inputContext) => {
        // get Pending Sync AP Voucher Data
        log.debug({
            title: '[getInputData stage]',
            details: 'start...'
        })

        return gwLibSyncVoucher.getPendingSyncAPVoucherData()
    }
    ...
    const reduce = (reduceContext) => {
        ...
        try {
            ...
            log.debug({title: 'proceed To Sync AP To B2B2 - searchResults', details: searchResults})
            gwLibSyncVoucher.proceedToSyncAPToB2B2(searchResults[0])
        } catch (e) {
