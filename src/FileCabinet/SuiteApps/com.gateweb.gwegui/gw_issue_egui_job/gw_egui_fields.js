define(['../library/ramda.min'], function (ramda) {
  ...
  var fieldInputMapping = (fieldConfig) => {
    return ramda.reduce(
  ...
  var lineFieldInputMapping = ramda.reduce(
    function (result, fieldId) {
  ...
  exports.bodyFieldInputMapping = fieldInputMapping(bodyFieldConfig)
  exports.lineFieldOutputMapping = lineFieldOutputMapping
  exports.lineFieldInputMapping = fieldInputMapping(lineFieldConfig)
